...
5.9. При подключении нового аппарата, в том числе при подключении переоформленных аппаратов, Абонент обязан оплатить полную или частичную абонентскую плату за текущий месяц. Частичная абоненская плата в размере 50% от стоимости ежемесячной абонентской платы применяется только в том случае, если аппарат был подключен в период с 11 по 25 число (включительно) месяца. Если аппарат был подключен в период с 26 числа до окончания месяца абоненская плата за текущий месяц не требуется. В случае если аппарат был подключен с 1 по 10 число (включительно) месяца Абонент обязан оплатить полную стоимость ежемесячной абонентской платы.
