...
4.5 Қолма-қол төлемдер бойынша операцияларды бақылау функциясы «бар күйінде» ұсынылады — көрсетілген деректер нақты түсімдерден ерекшеленуі мүмкін. Деректердің дәлдігі сыртқы факторларға, соның ішінде Вендинг жабдығының немесе онымен байланысты құрылғылардың ақауына не үйлесімсіздігіне байланысты болуы мүмкін. Осыған орай, Оператор көрсетілетін қызметтің дәлдігіне ешқандай кепілдік бермейді және деректердің дәл еместігі Абонентке қателіктер мен/немесе залал келтірген жағдайда, қандай да бір жауапкершіліктен босатылады.

4.6. Банктік шотты өзгерту және қайта рәсімдеу:

4.6.1. Егер Абонент Мобильді Қабылдағыш арқылы төлемдер түсетін банктік шотты өзгерткісі келсе, ол бұл туралы Операторды хабардар етіп, өзекті реквизиттерді ұсынуға міндетті.

4.6.2. Банктік шотты өзгерту деректерді тексеру және Эквайер Банктің жаңа ақпаратты растауынан кейін ғана жүзеге асырылады.

4.6.3. Мобильді Қабылдағышты қайта рәсімдеу (құрылғыны басқа иеге беру) жағдайында бұрынғы банктік шотқа байланыс жойылады. Жаңа иесі тіркеу және верификация рәсімінен өтіп, содан кейін Мобильді Қабылдағыш оның банктік шотына байланыстырылатын болады.

4.6.4. Қайта рәсімдеу операциясын орындау үшін Оператор белгілеген мөлшер мен тәртіп бойынша қызметтік алым алынады.
...
5.7.1. Абоненттің өтініші бойынша бұрын ажыратылған аппаратты қайта қосу жағдайында, Абонент айдың қай күні қайта қосылғанына қарамастан, толық айлық абоненттік төлемді төлеуге міндетті.

5.8. Оператор адалдық бағдарламасы шеңберінде Клиенттерге жеңілдетілген тариф ұсынуға құқылы. Жеңілдетілген тарифті ұсыну Оператордың міндеті емес, құқығы болып табылады.

5.8.1. Жеңілдетілген тариф Клиенттің абоненттік төлем бойынша төлемдердің үздіксіздігін сақтау шартымен беріледі. Төлемдердің үздіксіздігі деп Клиенттің әрбір есептік ай үшін абоненттік төлемді төленуге тиісті кезеңдерді өткізіп алмай енгізуі танылады.

5.8.2. Клиент абоненттік төлемді кез келген есептік ай үшін төлемеген жағдайда, себептеріне қарамастан, жеңілдетілген тарифті қолдану құқығы жойылады және тиісті айдан бастап Клиентке стандартты тариф қолданылады.
